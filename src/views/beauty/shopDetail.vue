<template>
    <div class="fullDetail">
      <div class="contentContainer">
        <div class="contentDetail">
          ...
          >
              ...
              <div class="content">
                <el-row :gutter="20">
                  <el-col :span="12">
                    ...
                    <el-form-item label-width="100px" :label="$t('common.qy2')" prop="enabled">
                            <el-switch v-model="merchantForm.enabled" active-color="#13ce66"
                  ...
                  <el-col :span="12">
                    ...
                    <!-- <el-form-item  label-width="80px" :label="$t('fapiaoku.dz')" style="margin-bottom: 0" > -->
                    <el-row style="margin-bottom: 15px">
                      <el-col :span="24">
                        ...
                        <!-- <el-form-item prop="company.houseNumber" :label="$t('common.mph')" label-width="90px">
                            <el-input v-model="merchantForm.company.houseNumber" autosize :placeholder="$t('common.mph')" show-word-limit></el-input>
                          </el-form-item> -->
                      </el-col>
                    </el-row>
            ...
            <div :class="{ 'payInfo': !!merchantForm.id, 'saleInfo': !merchantForm.id }">
              <div class="title">
                <span class="border"></span>
                <span class="tit">
                  {{ $t("common.addrInfo") }}
                      ...
                      <el-col :span="14">
                        ...
                        >
                          <el-select
                            ...
                            @change="
                              selectCountry2(merchantForm.address.countryId)
                            "
                            :placeholder="$t('common.gj')"
                            filterable
                          >
                        ...
                        <template v-if="merchantForm.address.countryId == 900001">
                          <el-form-item prop="address.provinceId">
                            <el-select
                              ...
                              @change="
                                selectProvince2(merchantForm.address.provinceId)
                              "
                              :placeholder="$t('common.sheng')"
                              filterable
                            >
            ...
            <div class="payInfo" v-if="!merchantForm.id">
                <div class="title">
                    <span class="border"></span>
                    <span class="tit">
                        {{ $t('common.subscriSet') }}
                    ...
                    <el-row :gutter="20">
                        <!-- <el-col :span="12">
                            <el-form-item label-width="120px" :label="$t('common.enablePac')"
                                prop="subscribe.enableTakeout">
                                <el-switch v-model="merchantForm.subscribe.enableTakeout" active-color="#13ce66"
                                    inactive-color="#ff4949"></el-switch>
                            </el-form-item>
                            <el-form-item label-width="120px" :label="$t('common.enableRev')"
                                prop="subscribe.enableReservation">
                                <el-switch v-model="merchantForm.subscribe.enableReservation"
                                    active-color="#13ce66" inactive-color="#ff4949"></el-switch>
                            </el-form-item>
                            <el-form-item label-width="120px" :label="$t('common.voucherTypeList[0].value')"
                                prop="subscribe.enableInvoice">
                                <el-switch v-model="merchantForm.subscribe.enableInvoice" active-color="#13ce66"
                                    inactive-color="#ff4949"></el-switch>
                            </el-form-item>
                            <el-form-item label-width="120px" :label="$t('common.enableCashChangePay')"
                                prop="subscribe.enableCashChangePay">
                                <el-switch v-model="merchantForm.subscribe.enableCashChangePay"
                                    active-color="#13ce66" inactive-color="#ff4949"></el-switch>
                            </el-form-item>
                            <el-form-item label-width="120px" :label="$t('common.webAppoint')"
                                prop="subscribe.enableWebReservation">
                                <el-switch v-model="merchantForm.subscribe.enableWebReservation"
                                    active-color="#13ce66" inactive-color="#ff4949"></el-switch>
                            </el-form-item>
                            <el-form-item label-width="120px" :label="$t('common.dishFeature')">
                                <el-switch
                                    v-model="merchantForm.subscribe.enableFoodFeature"
                                    active-color="#13ce66"
                        ...
                        <el-col :span="12">
                            <el-form-item label-width="120px" :label="$t('common.enableTax')"
                                prop="subscribe.enableCreditSafe">
                                <el-switch v-model="merchantForm.subscribe.enableCreditSafe"
                                    active-color="#13ce66" inactive-color="#ff4949"></el-switch>
                            </el-form-item>
                            <!-- <el-form-item label-width="120px" :label="$t('common.enableWebDistance')"
                                prop="subscribe.enableWebDistance">
                                <el-switch v-model="merchantForm.subscribe.enableWebDistance"
                                    active-color="#13ce66" inactive-color="#ff4949"></el-switch>
                            </el-form-item>
                            <el-form-item label-width="120px" :label="$t('common.searchType')"
                                prop="subscribe.addressSearchType">
                                <el-select v-model="merchantForm.subscribe.addressSearchType" size="mini"
                                    clearable>
                            ...
                            <el-form-item label-width="120px" :label="$t('common.enablePosPay')"
                                prop="subscribe.enablePosPay">
                                <el-switch v-model="merchantForm.subscribe.enablePosPay" active-color="#13ce66"
                                    inactive-color="#ff4949"></el-switch>
                            </el-form-item>
                            <el-form-item label-width="120px" :label="$t('common.enableApplet')"
                                prop="subscribe.enableApplet">
                                <el-switch v-model="merchantForm.subscribe.enableApplet" active-color="#13ce66"
                                    inactive-color="#ff4949"></el-switch>
                            </el-form-item> -->
                        </el-col>
                    </el-row>
      ...
      <input
        ...
        style="display: none"
      />
      <ChooseMerchant :showMer="showMer" @closeMer="cancleChoose"  @chooseMer="chooseMer"></ChooseMerchant>
    </div>
  </template>
    <script>
  import {
...
jkbShopUpdate,
  ...
  import ChooseMerchant from '@/views/components/chooseJkbMerchant';
  ...
  export default {
      ...
      return {
        ...
        merchantForm: {
            ...
            subscribe: {
                ...
                // enablePosPay: false,
                enableCreditSafe: true,
                // enableWebDistance: true,
                // enableWebReservation: false,
                // enableApplet: false,
                // addressSearchType: 103,
    ...
    methods: {
      ...
      chooseDoMer () {
        ...
        chooseMer (dt) {
            this.merchantForm.merchantId = dt.id;
            this.merchantForm.merchantName = dt.name;
            this.showMer = false;
            this.merchantForm.company = {
                type:dt.company.type,
                name: dt.company.name,
                vatNumber: dt.company.vatNumber,
                taxCode: dt.company.taxCode,
                countryId: dt.company.country.id,
                provinceId: dt.company.province.id,
                city: dt.company.city,
                zipcode: dt.company.zipcode,
                address: dt.company.address,
                contactName: dt.company.contactName,
                contactPhone: dt.company.contactPhone,
                contactEmail: dt.company.contactEmail,
                siret:  dt.company.siret,
                naf:  dt.company.naf,
                rcs:  dt.company.rcs,
                cs:  dt.company.cs,
            };
            if (dt.company.country) {
              this.initProvince(dt.company.country.id);
            }
            if (dt.company.province) {
              this.initCity(dt.company.province.id);
            }
            this.merchantForm.address = dt.address?{
                countryId: dt.address.country ? dt.address.country.id : "",
                provinceId:dt.address.province ? dt.address.province.id : "",
                city: dt.address.city,
                zipcode: dt.address.zipcode,
                address: dt.address.address,
                latitude: dt.address.latitude,
                longitude: dt.address.longitude,
                contactName: dt.address.contactName,
                contactPhone: dt.address.contactPhone,
                contactEmail: dt.address.contactEmail,
            }:{
                countryId: "",
                provinceId: "",
                city: "",
            ...
            if (dt.address) {
              if (dt.address.country) {
                this.initProvince2(dt.address.country.id);
              }
              if (dt.address.province) {
                this.initCity(dt.address.province.id);
              }
            }
        },
        cancleChoose () {
        ...
        jkbShopDetail(params).then((res) => {
          if (res.code === 20000) {
            this.merchantForm = {
              ...
              subscribe: {enableCreditSafe:res.data.subscribe?res.data.subscribe.enableCreditSafe:true},
              company: {
                type: 101,
