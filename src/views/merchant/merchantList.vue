<template>
    <el-container>
        ...
        <el-main style="padding: 0">
            ...
            <div class="table_container">
                ...
                >
                    ...
                    <el-table-column align="left" header-align="center" width="200" :label="$t('common.cz')"
                                     fixed="right">
                        <template slot-scope="scope">
                            ...
                            <el-button type="text" size="mini"
                                       @click="subscHandle(scope.row.id);">{{ $t('common.subscServe') }}
                            </el-button>
        ...
        <el-dialog :title="$t('common.employeeList')" :visible.sync="employee" width="60%" :close-on-click-modal="true" :show-close="true"
                        ...
                        <template slot-scope="scope">
                            <div class="logo" style="display: inline-block;vertical-align: middle;line-height: 1;">
                                <el-image style="width: 50px;height: 50px;border-radius: 50%; margin-right: 5px"
                                          :src="scope.row.avatar" fit="contain">
                                    <div slot="error" class="image-slot">
                                        <img src="../../assets/images/default.png" style="width: 50px;height: 50px;"/>
                                    </div>
                                </el-image>
...
export default {
    ...
    methods: {
        ...
        getSupplierList(page, rows) {
            ...
            getMerchantList(params).then(function (res) {
                if (res.code == 20000) {
        ...
        add(){
            this.$router.push({ name: 'MerchantDetail' });
        },
        revise(row) {
