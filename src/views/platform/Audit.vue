    ...
    <div class="container">
        <div class="container-header">
            <div class="search">
                ...
                <div class="search-item">
                    <span class="label">{{ $t('common.tm') }}:</span>
                    <el-input
                        size="mini"
                ...
                <div class="search-item">
                    <span class="label">{{ $t('common.approvalState') }}:</span>
                ...
                <el-table
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button
                                type="text"
                                @click="approveHandle(scope.row.id)"
                                v-if="scope.row.state === 101">
                                {{ $t('common.reviewPass') }}
                            </el-button>
                            <el-button
...
<script>
import {queryPlatformAuditPage, deletePlatformAudit, approvedPlatformAudit} from "../../api/api";
import Edit from "@/components/platform/audit/Edit";
export default {
    name: "PlatformAudit",
    // 组件
    components: {
    ...
    data() {
        return {
            ...
            stateOptions: [
                {
                    label: this.$t('common.createded'),
                    value: 101
                },
                {
                    label: this.$t('common.ysh'),
                    value: 102
                }
            ],
            search: {
    ...
    methods: {
        ...
        getListData() {
            ...
            queryPlatformAuditPage(params).then(res => {
                if (res.code === 20000) {
        ...
        approveHandle (id) {
            ...
            approvedPlatformAudit(params).then(res => {
                if (res.code === 20000) {
                    this.$message({
                        showClose: true,
                        message: res.msg,
        ...
        deleteHandle (id) {
            this.$confirm(this.$t('common.deleteIs'), this.$t('common.ts'), {
                ...
                deletePlatformAudit(params).then(res => {
                    if (res.code === 20000) {
                        this.$message({
                            showClose: true,
                            message: res.msg,
