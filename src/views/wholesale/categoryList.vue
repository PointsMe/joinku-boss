              ...
              <el-form-item :label="$t('common.sfxs')">
                ...
                <el-form-item :label="$t('common.tupian')">
                    <el-upload
                        ...
                        <img :src="addForm.image" class="avatar" v-if="addForm.image">
                        <div class="avatar-icon">
                            <i class="el-icon-delete" @click.stop="handleRemoveImage" v-if="addForm.image"></i>
