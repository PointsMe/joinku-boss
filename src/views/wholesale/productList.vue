                  ...
                  <el-col :span="24" style="display:flex;justify-content: space-between;">
                    <div>
                      <el-form-item>
                        ...
                        <el-select v-model="form.merchantId" :placeholder="$t('common.chooseWholesaler2')" filterable remote reserve-keyword :remote-method="remoteMethod" :loading="loading2">
                          <el-option
                    ...
                    <div>
                      ...
                      <el-dropdown class="user-name" :hide-on-click="false" trigger="click">
                        ...
                        <el-dropdown-menu slot="dropdown">
                          ...
                          <el-dropdown-item divided command="username">
                            <el-button type="primary" style="margin-left:0px;margin-top: 4px;" size="mini" @click="batchDelete">{{$t('common.batchDelete')}}</el-button>
                          </el-dropdown-item>
                        </el-dropdown-menu>
                      </el-dropdown>
                    </div>
        ...
        <el-main style="padding: 0">
          <div class="table_container">
            <el-table :data="productList" :height="heightDate" style="width: 100%; font-size: 12px" ref="table" v-loading="loading3"  @selection-change="handleSelectionChange">
              ...
              <el-table-column prop="raisePrice" align="center" width="120" :label="$t('common.changePrice')">
                <template slot-scope="scope">
            ...
            <div class="pagination">
              <el-pagination background @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage" :page-size="pagesize" layout="total, prev, pager, next, slot, jumper" :page-sizes="[15, 60, 120, 200]" :total="totalCount">
...
import ChooseSupplier from '@/views/wholesale/chooseSupplier';
import ChooseProduct from '@/views/wholesale/chooseProduct';
import ChooseCategory from '@/views/wholesale/chooseCategory';
...
export default {
  ...
  methods: {
    ...
    geterjiClassify() {
      var that = this;
      var params = new URLSearchParams();
      params.append("type", 101);
      classifyTree(params).then(res => {
        if (res.code === 20000) {
          that.classifyList2 = JSON.parse(JSON.stringify(res.data));
          if (that.classifyList2.length > 0) {
            for (let i = 0; i < that.classifyList2.length; i++) {
              that.classifyList2[i].children.forEach(item => {
                item.children = '';
              });
            }
          }
